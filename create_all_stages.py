...
stages_config = [
    {
        ...
        'folder': 'f2',
        'pdf': 'cours2.pdf',
        'img1': 'debut.jpg', 'img2': 'v.jpg', 'img3': 'p.png'
    },
    {
        'stage_num': 3,
        ...
        'folder': 'f3',
        'pdf': 'cours3.pdf',
        'img1': 'debut.png', 'img2': 'v.jpg', 'img3': 'p.png'
    },
    {
        'stage_num': 4,
        ...
        'folder': 'f4',
        'pdf': 'cours2.pdf',
        'img1': 'debut.png', 'img2': 'v.png', 'img3': 'p.png'
    },
    {
        'stage_num': 5,
    ...
    },
    {
        ...
        'folder': 'f6',
        'pdf': 'cours6.pdf',
        'img1': 'debut.jpg', 'img2': 'v.png', 'img3': 'p.png'
    },
    {
        'stage_num': 7,
    ...
    },
    {
        ...
        'folder': 'f1',
        'pdf': 'cours1.pdf',
        'img1': 'debut.png', 'img2': 'v.jpg', 'img3': 'p.jpg'
    },
    {
        'stage_num': 9,
...
<head>
    ...
    <title>{{ICON}} {{TITLE}} - 6 Étapes Complètes</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root { --candy-red:#E91E63; --candy-orange:#FF9800; --candy-yellow:#FFD54F; --candy-green:#26C281; --candy-teal:#00BCD4; --candy-blue:#2196F3; --candy-purple:#9C27B0; --candy-pink:#EC407A; --bg-deep:#0D0221; --bg-mid:#1A0033; --bg-card:#2B0A54; --text-light:#FFFFFF; --text-muted:rgba(255,255,255,0.65); --border-r:20px; }
        *{margin:0;padding:0;box-sizing:border-box;}html,body{height:100%;font-family:'Nunito',sans-serif;background:var(--bg-deep);color:var(--text-light);overflow-x:hidden;}
        ...
        .resource-display:hover{transform:scale(1.05);box-shadow:0 0 30px rgba(255,215,0,0.5);animation:bounce 0.6s ease-in-out;}
        ...
        .image-container,.pdf-container{width:100%;max-height:600px;background:#000;border-radius:15px;overflow:hidden;box-shadow:0 8px 30px rgba(0,0,0,0.4);margin-bottom:25px;border:3px solid var(--candy-blue);display:flex;align-items:center;justify-content:center;animation:slideIn 0.6s ease-out;}
        ...
        .btn:hover{transform:translateY(-3px) translateX(0);box-shadow:0 6px 20px rgba(156,39,176,0.6);animation:bounce 0.6s ease-in-out;}.btn:active{transform:translateY(-1px);}.btn-prev{background:linear-gradient(135deg,var(--candy-blue) 0%,var(--candy-teal) 100%);}
        ...
        @media (max-width:768px){.stage-header h1{font-size:1.8rem;}.step-icon{width:60px;height:60px;font-size:1.8rem;}.stage-content{padding:25px;}.steps-progress{gap:10px;}.step{min-width:100px;}}
    </style>
</head>
<body>
        ...
        <div class="stage-content">
            <div class="step-content active">
                ...
                <div class="image-container">
                    <img src="assets/stage/{{FOLDER}}/{{IMG1}}" alt="صورة البداية">
                </div>
                <div class="text-content">
                    <h3>مرحباً بك في رحلة تعليمية رائعة!</h3>
                    <p>هذه الصورة تمثل بداية رحلتك في فهم {{TITLE}}. ستتعلم في هذه المرحلة المفاهيم الأساسية.</p>
                </div>
            </div>
            <div class="step-content">
                <h2>🎨 الخطوة 2: الصور التوضيحية (V1)</h2>
                <div class="image-container">
                    <img src="assets/stage/{{FOLDER}}/{{IMG2}}" alt="صورة توضيحية v1">
                </div>
                <div class="text-content">
                    <h3>فهم أعمق للموضوع</h3>
                    <p>هذه الصورة تقدم لك رؤية مفصلة عن {{TITLE}}. لاحظ العناصر المختلفة.</p>
                </div>
            </div>
            <div class="step-content">
                <h2>📸 الخطوة 3: معلومات متقدمة (P)</h2>
                <div class="image-container">
                    <img src="assets/stage/{{FOLDER}}/{{IMG3}}" alt="صورة توضيحية p">
                </div>
                <div class="text-content">
                    <h3>تفاصيل إضافية مهمة</h3>
                    <p>هذه الصورة توفر معلومات إضافية وتفاصيل متقدمة. ركز على النقاط الرئيسية.</p>
                </div>
            </div>
            <div class="step-content">
                ...
                <div style="margin-top:20px;padding:15px;background:rgba(33,150,243,0.1);border-radius:10px;border-left:4px solid var(--candy-blue);">
                    <p style="color:var(--text-light);">📖 اقرأ الدرس بعناية قبل الاختبار.</p>
                </div>
            </div>
            <div class="step-content">
                <h2>❓ الخطوة 5: اختبر معلوماتك</h2>
                <div class="qcm-container">
                    <div class="question-card" data-question="q1" data-answer="ب"><h3>السؤال 1: ما هو المجال الجغرافي؟</h3><div class="options"><button class="option-btn" onclick="selectOption(this,'q1')">أ) مساحة خاصة بالزراعة</button><button class="option-btn" onclick="selectOption(this,'q1')">ب) رقعة محددة لها حدود وخصائص</button><button class="option-btn" onclick="selectOption(this,'q1')">ج) مكان خالٍ من السكان</button></div><button class="verify-btn" onclick="verifyAnswer('q1')">✓ تحقق</button><div class="answer-explanation"></div></div>
                    <div class="question-card" data-question="q2" data-answer="ب"><h3>السؤال 2: ما الذي يشمله المجال الطبيعي؟</h3><div class="options"><button class="option-btn" onclick="selectOption(this,'q2')">أ) المدارس</button><button class="option-btn" onclick="selectOption(this,'q2')">ب) الصخور والهواء والماء</button><button class="option-btn" onclick="selectOption(this,'q2')">ج) الطرقات</button></div><button class="verify-btn" onclick="verifyAnswer('q2')">✓ تحقق</button><div class="answer-explanation"></div></div>
                    <div class="question-card" data-question="q3" data-answer="ب"><h3>السؤال 3: ماذا يمثل المجال الجغرافي اجتماعياً؟</h3><div class="options"><button class="option-btn" onclick="selectOption(this,'q3')">أ) التضاريس فقط</button><button class="option-btn" onclick="selectOption(this,'q3')">ب) العلاقات الاجتماعية والقيم</button><button class="option-btn" onclick="selectOption(this,'q3')">ج) المناخ</button></div><button class="verify-btn" onclick="verifyAnswer('q3')">✓ تحقق</button><div class="answer-explanation"></div></div>
                    <div class="question-card" data-question="q4" data-answer="ب"><h3>السؤال 4: ما هو المجال الجوي؟</h3><div class="options"><button class="option-btn" onclick="selectOption(this,'q4')">أ) اليابسة</button><button class="option-btn" onclick="selectOption(this,'q4')">ب) الفضاء الجوي الخاص</button><button class="option-btn" onclick="selectOption(this,'q4')">ج) البحار</button></div><button class="verify-btn" onclick="verifyAnswer('q4')">✓ تحقق</button><div class="answer-explanation"></div></div>
                    <div class="question-card" data-question="q5" data-answer="ج"><h3>السؤال 5: ما هو المجال البحري؟</h3><div class="options"><button class="option-btn" onclick="selectOption(this,'q5')">أ) الأراضي الزراعية</button><button class="option-btn" onclick="selectOption(this,'q5')">ب) الفضاء الجوي</button><button class="option-btn" onclick="selectOption(this,'q5')">ج) أجزاء البحار</button></div><button class="verify-btn" onclick="verifyAnswer('q5')">✓ تحقق</button><div class="answer-explanation"></div></div>
                </div>
            </div>
            <div class="step-content">
    ...
    <script>
        let currentStep=1;const totalSteps=6;const selectedAnswers={};const answeredQuestions={q1:0,q2:0,q3:0,q4:0,q5:0};const correctAnswers={q1:'ب',q2:'ب',q3:'ب',q4:'ب',q5:'ج'};const explanations={q1:{correct:'✓أحسنت!',incorrect:'✗للأسف.'}, q2:{correct:'✓أحسنت!',incorrect:'✗للأسف.'}, q3:{correct:'✓أحسنت!',incorrect:'✗للأسف.'}, q4:{correct:'✓أحسنت!',incorrect:'✗للأسف.'}, q5:{correct:'✓أحسنت!',incorrect:'✗للأسف.'}};const gameState={userId:sessionStorage.getItem('userId')||'user-'+Date.now(),diamonds:150,coins:750};function goToStep(s){if(s>=1&&s<=totalSteps){currentStep=s;updateUI();}}function nextStep(){if(currentStep===5){const a=['q1','q2','q3','q4','q5'].every(q=>answeredQuestions[q]);if(!a){alert('الإجابة على جميع!');return;}}if(currentStep<totalSteps){currentStep++;updateUI();}else if(currentStep===totalSteps){evaluateEssay();}}function previousStep(){if(currentStep>1){currentStep--;updateUI();}}function updateUI(){document.querySelectorAll('.step-content').forEach((e,i)=>{e.classList.toggle('active',i+1===currentStep);});document.querySelectorAll('.step').forEach((e,i)=>{e.classList.toggle('active',i+1===currentStep);});document.getElementById('prevBtn').style.display=currentStep>1?'flex':'none';document.getElementById('nextBtn').textContent=currentStep===totalSteps?'✅تقييم':'التالي ➡️';window.scrollTo({top:0,behavior:'smooth'});}function selectOption(b,q){b.parentElement.querySelectorAll('.option-btn').forEach(x=>{x.classList.remove('selected');});b.classList.add('selected');selectedAnswers[q]=b.textContent.trim().charAt(0);}function verifyAnswer(q){if(!selectedAnswers[q]){alert('اختر!');return;}const c=document.querySelector(`[data-question="${q}"]`);const ans=correctAnswers[q];const u=selectedAnswers[q];const ok=u===ans;answeredQuestions[q]=1;c.querySelectorAll('.option-btn').forEach(b=>{b.classList.add('disabled');if(b.textContent.trim().charAt(0)===ans){b.classList.add('correct-answer');}if(b.classList.contains('selected')&&!ok){b.classList.add('wrong-answer');}});if(ok){c.classList.add('correct');gameState.diamonds+=10;gameState.coins+=25;}else{c.classList.add('incorrect');}const ex=c.querySelector('.answer-explanation');ex.textContent=ok?explanations[q].correct:explanations[q].incorrect;ex.classList.add('show');c.querySelector('.verify-btn').disabled=true;c.querySelector('.verify-btn').textContent=ok?'✅صحيح':'❌خطأ';updateResources();}function evaluateEssay(){const e=document.getElementById('student-essay').value.trim();if(!e){alert('اكتب!');return;}const w=e.split(/\s+/).length;const s=Math.min(100,Math.max(50,w*2));const d=Math.floor(s/10)*15;const coins=Math.floor(s/5)*20;const h=`<h2>✅تم!</h2><div class="reward">⭐${s}%</div><div class="reward">💎+${d}</div><div class="reward">🪙+${coins}</div><p style="margin-top:20px;color:var(--text-light);">احسنت!</p>`;document.getElementById('evaluation-area').innerHTML=h;document.getElementById('evaluation-area').style.display='block';gameState.diamonds+=d;gameState.coins+=coins;updateResources();document.getElementById('nextBtn').textContent='🏠العودة';document.getElementById('nextBtn').onclick=()=>window.location.href='dashboard.html';}function updateResources(){document.getElementById('diamonds-count').textContent=gameState.diamonds;document.getElementById('coins-count').textContent=gameState.coins;}document.addEventListener('DOMContentLoaded',()=>{updateUI();updateResources();});
    </script>
</body>
</html>'''
...
for stage in stages_config:
    ...
    content = content.replace('{{IMG1}}', stage['img1'])
    content = content.replace('{{IMG2}}', stage['img2'])
    content = content.replace('{{IMG3}}', stage['img3'])
    ...
    print(f"✓ {stage['title'][:30]}... créé: {stage['filename']}")

print(f"\n🎉 Tous les {len(stages_config)} stages créés!")
